...
--
-- Client :  127.0.0.1
-- Généré le :  Ven 22 Février 2019 à 15:07
...
CREATE TABLE `comments` (
  `id` int(11) NOT NULL,
  `attente_moderation` varchar(255) NOT NULL DEFAULT '0',
  `post_id` int(11) NOT NULL,
  `author` varchar(255) NOT NULL,
  `comment` text NOT NULL,
  `comment_date` date NOT NULL,
  `arborescence` int(2) NOT NULL,
  `comment_parent` int(20) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
INSERT INTO `comments` (`id`, `attente_moderation`, `post_id`, `author`, `comment`, `comment_date`, `arborescence`, `comment_parent`) VALUES
(52, '0', 17, 'test arbo 2', 'arbo 2', '2019-02-22', 2, 51),
(51, '0', 17, 'audrey', 'test commentaire', '2019-02-22', 1, 1),
(54, '0', 18, 'test ', 'test', '2019-02-22', 1, 1),
(55, '0', 18, 'test 1', 'test 1', '2019-02-22', 1, 1);
...
CREATE TABLE `posts` (
  `id` int(11) NOT NULL,
  `img` varchar(155) NOT NULL DEFAULT 'mckayla-crump-675004-unsplash.jpg',
...
(17, 'mckayla-crump-675004-unsplash.jpg', 'titre', 'jeannin', 'testt', '2019-01-12 22:47:27'),
(18, 'paxson-woelber-534783-unsplash.jpg', 'Chapitre erg', 'dfdghei', '<p>ultimate test</p>', '2019-01-12 22:47:18'),
